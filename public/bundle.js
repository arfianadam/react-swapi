...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = _react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: '/categories/:category/:id', component: _Detail2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/autoprefixer-loader/index.js?{browsers:[\"Android 2.3\", \"Android >= 4\", \"Chrome >= 20\", \"Firefox >= 24\", \"Explorer >= 8\", \"iOS >= 6\", \"Opera >= 12\", \"Safari >= 6\"]}!./../../node_modules/less-loader/index.js!./Header.less", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/autoprefixer-loader/index.js?{browsers:[\"Android 2.3\", \"Android >= 4\", \"Chrome >= 20\", \"Firefox >= 24\", \"Explorer >= 8\", \"iOS >= 6\", \"Opera >= 12\", \"Safari >= 6\"]}!./../../node_modules/less-loader/index.js!./Header.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "cecfcce3f35bf40d374a9cb21034fbae.jpg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js?{browsers:[\"Android 2.3\", \"Android >= 4\", \"Chrome >= 20\", \"Firefox >= 24\", \"Explorer >= 8\", \"iOS >= 6\", \"Opera >= 12\", \"Safari >= 6\"]}!./../node_modules/less-loader/index.js!./main.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js?{browsers:[\"Android 2.3\", \"Android >= 4\", \"Chrome >= 20\", \"Firefox >= 24\", \"Explorer >= 8\", \"iOS >= 6\", \"Opera >= 12\", \"Safari >= 6\"]}!./../node_modules/less-loader/index.js!./main.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'p',
	        null,
	        'This is a fun project made by me, Arfian Adam. I used Star Wars API collection at ',
	        _react2.default.createElement(
	          _reactRouter.Link,
	          { to: 'http://swapi.co' },
	          'Swapi.co'
	        ),
	        '. This project is build on React without any Redux implementation like Flux to keep it simple and easy to understand. You can find the source code at ',
	        _react2.default.createElement(
	          _reactRouter.Link,
	          { to: 'https://github.com/arfianadam/react-swapi' },
	          'Github'
	        ),
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: 'mailto:contact@arfianadam.com' },
	          'contact@arfianadam.com'
	        )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactWaypoint = __webpack_require__(234);
	...
	exports.default = _react2.default.createClass({
	  ...
	  insertItems: function insertItems(content) {
	  ...
	  loadItems: function loadItems() {
	    if (!this.state.isLoading) {
	      ...
	      var content = _Api2.default.getList(category, page, this.insertItems);
	    } else {
	  ...
	  waypoint: function waypoint() {
	    if (!this.state.isLoading) {
	      return _react2.default.createElement(_reactWaypoint2.default, { onEnter: this.loadItems });
	    }
	  },
	  render: function render() {
	    var caps = function caps(string) {
	    ...
	    var renderItems = data.map(function (item, index) {
	      return _react2.default.createElement(_Panel2.default, { data: item, key: index });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		getList: function getList(category, page, callback) {
			_superagent2.default.get('http://swapi.co/api/' + category + '/?page=' + page).end(function (err, res) {
				// log the error
				if (err) {
					console.log(err);
				} else {
		...
		getDetail: function getDetail(category, id, callback) {
			_superagent2.default.get('http://swapi.co/api/' + category + '/' + id).end(function (err, res) {
				// log the error
				if (err) {
					console.log(err);
				} else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/autoprefixer-loader/index.js?{browsers:[\"Android 2.3\", \"Android >= 4\", \"Chrome >= 20\", \"Firefox >= 24\", \"Explorer >= 8\", \"iOS >= 6\", \"Opera >= 12\", \"Safari >= 6\"]}!./../../node_modules/less-loader/index.js!./Detail.less", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/autoprefixer-loader/index.js?{browsers:[\"Android 2.3\", \"Android >= 4\", \"Chrome >= 20\", \"Firefox >= 24\", \"Explorer >= 8\", \"iOS >= 6\", \"Opera >= 12\", \"Safari >= 6\"]}!./../../node_modules/less-loader/index.js!./Detail.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
		...
		componentWillMount: function componentWillMount() {
			...
			_Api2.default.getDetail(category, id, this.setContent);
		},
		reloadData: function reloadData(category, id) {
			_Api2.default.getDetail(category, id, this.setContent);
		},
		...
		render: function render() {
			...
			var links = ['films', 'characters', 'people', 'pilots', 'planets', 'species', 'homeworld', 'residents', 'starships', 'vehicles', 'url'];

			var getQuery = function getQuery(string) {
				var link = string.substring(20);
				return link;
			};
			var renderContent = Object.keys(data).map(function (key, index) {
				if ($.inArray(key, links) > -1) {
					var convertToLink = function convertToLink(string, index) {
						var _this = this;
						...
						return _react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ to: '/categories/' + link, onClick: function onClick() {
										return _this.reloadData(category, id);
									} },
								category + ' - ' + id
							)
						);
					...
					return _react2.default.createElement(
							...
							_react2.default.createElement(
									...
									_react2.default.createElement(
											...
											_react2.default.createElement(
													'div',
													{ className: 'col-md-6 section films' },
													_react2.default.createElement(
															'h2',
															null,
															'Films'
									...
									_react2.default.createElement(
											...
											_react2.default.createElement(
													'div',
													{ className: 'col-md-6 section people' },
													_react2.default.createElement(
															'h2',
															null,
															'People'
									...
									_react2.default.createElement(
											_reactRouter.Link,
											{ to: '/categories/planets' },
											_react2.default.createElement(
													'div',
													{ className: 'col-md-6 section planets' },
													_react2.default.createElement(
															'h2',
															null,
															'Planets'
									...
									_react2.default.createElement(
											_reactRouter.Link,
											{ to: '/categories/species' },
											_react2.default.createElement(
													'div',
													{ className: 'col-md-6 section species' },
													_react2.default.createElement(
															'h2',
															null,
															'Species'
									...
									_react2.default.createElement(
											_reactRouter.Link,
											{ to: '/categories/starships' },
											_react2.default.createElement(
													'div',
													{ className: 'col-md-6 section starships' },
													_react2.default.createElement(
															'h2',
															null,
															'Starships'
									...
									_react2.default.createElement(
											...
											_react2.default.createElement(
													'div',
													{ className: 'col-md-6 section vehicles' },
													_react2.default.createElement(
															'h2',
															null,
															'Vehicles'
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/autoprefixer-loader/index.js?{browsers:[\"Android 2.3\", \"Android >= 4\", \"Chrome >= 20\", \"Firefox >= 24\", \"Explorer >= 8\", \"iOS >= 6\", \"Opera >= 12\", \"Safari >= 6\"]}!./../../node_modules/less-loader/index.js!./Home.less", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/autoprefixer-loader/index.js?{browsers:[\"Android 2.3\", \"Android >= 4\", \"Chrome >= 20\", \"Firefox >= 24\", \"Explorer >= 8\", \"iOS >= 6\", \"Opera >= 12\", \"Safari >= 6\"]}!./../../node_modules/less-loader/index.js!./Home.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "685467ce5dd587230c3abfac8edb8e23.jpg";

/***/ },
/* 250 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "328ad208393b03f67bb9a32830b086db.jpg";

/***/ },
/* 251 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "9233eb757f9a6bc3db83109edcd687a5.jpg";

/***/ },
/* 252 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "fa49dff8d287ff5223bb804a5f36e093.jpg";

/***/ },
/* 253 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "fabbdc032a063541c0c692211d6cb07a.jpg";

/***/ },
/* 254 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "59dfb102290d96a126ac50f5df143eeb.jpg";
